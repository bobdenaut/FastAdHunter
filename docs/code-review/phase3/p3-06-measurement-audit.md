...
| Pinned / banking app unaffected | `an_excluded_sni_splices_even_for_a_listed_client` (fah-http harness) | Runbook 4; meaningless until `BASELINE_EXCLUSIONS` names the app's hosts |
