...
component of the measured ~15–16k QPS ceiling, which `docs/code-review/p1.5-06-review.md`
...
`docs/code-review/0.2.7-router-memory-and-throughput.md` §2.** This section
