...
(layout, occupancy), [szprobe.rs](../phase2/p2-12-attribution/szprobe.rs) (transient).
...
| `docs/code-review/phase1/p1-01-ab/` | A/B instruments, runners, raw output (new) |
...
| ---- | -------------- |
| M4 | Fixed — see §M4 |
| m5 | Carried from [p2-03-review.md](../phase2/p2-03-review.md) §Raised, not fixed — still open |
